...
In order to develop the Bayesian regression model to predict `audience_score` from the explanatory variables indicated in the instructions, we will use the function `mutate` to create the new variables requiered as follows:
...
After creating the new variables, we will select the variables requiered for the analysis described in the instructions:
