...
The aim of the first part of this project is to assess whether:
...
From the linear regression we learnt that in fact the popularity of a movie can be predicted by considering characteristic data such as genre, MPAA rating, number of IMDb votes, and whether the director has ever won an award. 
...
First of all, we will select variables that are interesting for this part of the project:
